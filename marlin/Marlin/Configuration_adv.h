...
// Remap E0 port to control Y2 stepper
#define HAS_Y2_STEPPER  true
#define Y2_STEP_PIN     E1_STEP_PIN
#define Y2_DIR_PIN      E1_DIR_PIN
#define Y2_ENABLE_PIN   E1_ENABLE_PIN

#if HAS_Y2_STEPPER
  // the belts of lowrider are consumed in complemented directions
  #define INVERT_Y2_VS_Y_DIR          // Y2 direction signal is the opposite of Y
  #define Y_DUAL_ENDSTOPS             // Y2 has its own endstop
  #if ENABLED(Y_DUAL_ENDSTOPS)
    #define Y2_STOP_PIN           E0_DIAG_PIN   // Y2 endstop pin override
    #define Y2_ENDSTOP_ADJUSTMENT 0             // Y2 offset relative to Y endstop
  #endif
#endif

// Remap E1 port to control Z2 stepper
...
//
  ...
  #define Z_MULTI_ENDSTOPS            // Other Z axes have their own endstops
    ...
    #define Z2_STOP_PIN           PC15 // Z2 endstop pin override
...
#define AXIS_RELATIVE_MODES { false, false, false } // we have no E axis, only X Y Z
 ...
 */
  ...
  #define DIAG_JUMPERS_REMOVED  // LR3 setup configured with jumper removed
