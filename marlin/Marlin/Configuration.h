 ...
 * 
 * Configuration for V1 engineering Lowrider
 * (in my case v3, but should also work for other versions)
 * 
...
#define STRING_CONFIG_H_AUTHOR "(brederle@github.com, LR Manta M5P CNC)" // Original author or contributor.
...
#ifndef MOTHERBOARD
  // use the overridden remapped spec for lowrider
...
#define CUSTOM_MACHINE_NAME "LowRider V3 Manta M5P - CNC"
//#define CONFIGURABLE_MACHINE_NAME // Add G-code M550 to set/report the machine name

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "a50bbf77-5a90-400e-990a-422bd745fa1c"
...
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
#define EXTRUDERS 0   // no extruders for CNC
 ...
 */
#define TEMP_SENSOR_0 0         // no sensor for CNC
...
#define TEMP_SENSOR_BED 0       // no bed for CNC
...
//#define ENDSTOPPULLUPS    // Manta M5p board has physical pullups 
 ...
 *
 * Normally open + pull-up = activated on HIGH signal
 */
...
//for Manta M5P, it is PC13 (2-wire BLTouch pins)
...
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR 1  // lowrider v3 y sensors on max
#define Z_HOME_DIR 1  // lowrider v3 z sensors on max
//#define I_HOME_DIR -1
//#define J_HOME_DIR -1
//#define K_HOME_DIR -1
//#define U_HOME_DIR -1
...
#define X_BED_SIZE 800    // brederle: the size of my lowride, max. 1220
#define Y_BED_SIZE 1200   // brederle: the size of my lowride, max. 2440
...
// for the moment LR3 is running without any display
